...
def read_file(file_names):
    for i, file in enumerate(file_names):
        with open(os.path.join(file_path, file), 'r', encoding='utf-8', errors='replace') as f:
            reviews, scores = read_single_json(f)


vocab = {}

file_path = r"D:\datasets\yelp\sorted_data"
...
valid_filename = files[train_size:(train_size + valid_size)]
test_filename = files[train_size + valid_size:]

review_train_number, review_valid_number, review_test_number = 0, 0, 0
score_ana_train, score_ana_valid, score_ana_test = {}, {}, {}
